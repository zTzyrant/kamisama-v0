...
export const blogPosts: BlogPost[] = [
    {
        ...
        excerpt: "Why maximalism is dying and how raw, unpolished aesthetics are reshaping the digital landscape in 2026.",
        date: "FEB 24, 2026",
        category: "FEATURED",
        tags: ["#WEBDEVELOPMENT", "#UIUXDESIGN", "#BRUTALISM", "#CSSART", "#JAVASCRIPT", "#TYPOGRAPHY", "#ACCESSIBILITY"],
    ...
    },
    {
        ...
        excerpt: "Brutalism in web design is more than just an aesthetic choice—it's a philosophy that embraces raw, unpolished beauty and challenges conventional design norms. Learn the key principles.",
        date: "JAN 06, 2026",
        category: "DESIGN",
        tags: ["CSS", "DESIGN"],
    ...
    },
    {
        ...
        excerpt: "The latest update brings concurrent rendering improvements and automatic batching. Here is a deep dive into how it changes your workflow.",
        date: "JAN 04, 2026",
    ...
    },
    {
        ...
        excerpt: "How we built a responsive, neon-infused grid system using only CSS Grid and variables. No JS required.",
        date: "DEC 28, 2025",
        category: "SHOWCASE",
        tags: ["GRID", "CSS"],
