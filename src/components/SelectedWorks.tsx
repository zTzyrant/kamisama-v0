...
export default function SelectedWorks() {
  ...
  return (
    <section class="bg-surface relative py-32 border-t border-white/10 overflow-hidden">
      ...
      <div class="max-w-[1920px] mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-end mb-20 border-b border-white/10 pb-8">
          <h2 class="font-oswald text-6xl md:text-8xl text-white uppercase tracking-tighter leading-none">
            My
            <br />
            <span
          ...
          <div class="mt-8 md:mt-0 flex gap-4">
            <button class="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-black transition-all">
          ...
          <For each={works}>
            {(work) => (
              ...
              >
                ...
                <div class="flex justify-between items-start border-t border-white/20 pt-4">
                  <div>
                    <h3 class="font-oswald text-3xl uppercase text-white mb-1 group-hover:text-primary transition-colors">
                      {work.title}
                    </h3>
